...
echo -e "\n🔥 Applet icon size settings set 🔥"
echo -e "----------------------------------------"

# Set what to show on desktop
...
echo -e "\n🔥 Alt+Tab behavior settings set 🔥"
echo -e "----------------------------------------"

# Set date format
gsettings set org.cinnamon date-format "YYYY-MM-DD"
echo -e "\n🔥 Date format settings set 🔥"
echo -e "----------------------------------------"
...
echo -e "\n🔥 First day of week settings set 🔥"
echo -e "----------------------------------------"
